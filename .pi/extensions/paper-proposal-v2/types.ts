...
export type { ScientificThread, ScientificDecision, ScientificEvent, ThreadRelation, ThreadSynthesis, ScientificAct, ProjectEntryState, ScientificWorkflowOperation, ScientificWorkflowPublicStatus, ScientificActKind, ScientificThreadStatus, ScientificDecisionStatus, ScientificEventType, ThreadRelationKind, ThreadSynthesisStatus, MaterializationState, ScientificActorKind, ConceptualReviewOutcome, ScientificResolutionStatus, ScientificAuditStatus, ScientificWorkflowRequest, ScientificWorkflowPublicResult } from './scientific-domain.js';
