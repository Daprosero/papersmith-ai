...
export function getRuntimeMetrics():RuntimeMetrics{return {...metrics,routeMetrics:{routeSelections:{...metrics.routeMetrics.routeSelections},bypassedStageSelections:{...metrics.routeMetrics.bypassedStageSelections}},scientificMetrics:{...metrics.scientificMetrics}}}
