...
Sixty-five distinct codes are raised inside the nine gating commands — `apply`,
...
- **No — a *work state*** (31 codes). Somebody must act on the repository, so
