import { complete, type UserMessage } from './_pi-compat/pi-ai-compat.js';
import type { ExtensionContext } from './_pi-compat/pi-coding-agent.js';
...
export const MODIFY_INPUT_BUDGET_ENV = 'PAPER_PROPOSAL_MODIFY_INPUT_BUDGET_BYTES';
