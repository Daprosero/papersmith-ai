// Design `sdd/paper-proposal-base-reconciliation`: a deterministic, read-only
// `STATUS` operation on the ambient-model paper-proposal CLI host. It gives
...
function keylessEnv(projectRoot) {
	const env = { ...process.env, PAPER_PROPOSAL_PROJECT_ROOT: projectRoot };
