// CREATE_SUCCESSOR locus-inference + byte-preservation coverage (paper-proposal-tutor-repair, tasks 1.3/1.4).
//
// Exercises orchestrator.ts's interactive CREATE_SUCCESSOR pipeline directly
// (in-memory PaperProposalOrchestrator over a real temp-dir workspace; no
// proposal .md is authored anywhere in the repository — only ephemeral
// tmpdir fixtures, same pattern as tests/paper-proposal-v2-source-routing.test.mjs).
//
