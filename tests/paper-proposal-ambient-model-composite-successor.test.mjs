...
// (design `sdd/paper-proposal-ambient-model`, SLICE 1b): extends SLICE 1's
// replace-only ambient-supplied path (tests/paper-proposal-ambient-model-create-successor.test.mjs)
