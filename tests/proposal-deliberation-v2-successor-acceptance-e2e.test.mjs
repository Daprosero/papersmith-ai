...
// `createProposalDeliberationExtension`'s `tutor`/`semanticPlanner` options instead --
...
async function fixture() {
 ...
 const tools = [];
 workspace.createProposalDeliberationExtension({ projectRoot, operationGuard: guard, tutor, semanticPlanner })({ registerTool: tool => tools.push(tool), on: () => {} });
