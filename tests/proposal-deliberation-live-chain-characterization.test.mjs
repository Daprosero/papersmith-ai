...
test('lifecycle-v1 materialization preserves $$ math delimiters and applies the decision at its resolved locus (Phase 1 repair, V1 + V2 + V6)', async () => {
	const projectRoot = await mkdtemp(path.join(tmpdir(), 'proposal-deliberation-live-chain-'));
	try {
		...
		// Exercises the exact call contract cli.mjs's registered proposal_deliberation_execute
