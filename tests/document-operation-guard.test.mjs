...
const source = await readFile('skills/_core/deliberation/engine/proposal-workspace.ts', 'utf8');
const intents = await readFile('skills/_core/deliberation/engine/types.ts', 'utf8');
