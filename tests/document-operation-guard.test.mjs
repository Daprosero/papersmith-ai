...
const source = await readFile('.claude/skills/_core/deliberation/engine/proposal-workspace.ts', 'utf8');
const intents = await readFile('.claude/skills/_core/deliberation/engine/types.ts', 'utf8');
