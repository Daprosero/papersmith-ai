...
const domainPath = path.join(root, '.claude/skills/proposal-deliberation/engine/scientific-domain.ts');
...
test('scientific implementation files have one shared contract owner', async () => {
	const directory = path.join(root, '.claude/skills/proposal-deliberation/engine');
